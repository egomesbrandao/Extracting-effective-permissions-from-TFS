        ...
        private static readonly List<Permission> Permissions = new List<Permission>
                                                                   {
                                                                       ...
                                                                       // Git Source Control
                                                                       new Permission(PermissionScope.GitSourceControl, "Administer", "Administer", "TeamFoundation.Git.Common.GitRepositoryPermissionsNames.Administer", 1, string.Empty), 
                                                                       new Permission(PermissionScope.GitSourceControl, "Read", "GenericeRead", "TeamFoundation.Git.Common.GitRepositoryPermissionsNames.GenericRead", 2, string.Empty), 
                                                                       new Permission(PermissionScope.GitSourceControl, "Contribute", "GenericContribute", "TeamFoundation.Git.Common.GitRepositoryPermissionsNames.GenericContribute", 3, string.Empty), 
                                                                       new Permission(PermissionScope.GitSourceControl, "Rewrite and destroy history (force push)", "ForcePush", "TeamFoundation.Git.Common.GitRepositoryPermissionsNames.ForcePush", 5, string.Empty),
                                                                       new Permission(PermissionScope.GitSourceControl, "Branch Creation", "CreateBranch", "TeamFoundation.Git.Common.GitRepositoryPermissionsNames.CreateBranch", 8, string.Empty), 
                                                                       new Permission(PermissionScope.GitSourceControl, "Tag Creation", "CreateTag", "TeamFoundation.Git.Common.GitRepositoryPermissionsNames.CreateTag", 13, string.Empty), 
                                                                       new Permission(PermissionScope.GitSourceControl, "Note Management", "ManageNote", "TeamFoundation.Git.Common.GitRepositoryPermissionsNames.ManageNote", 21, string.Empty), 
                                                                   };
